...
double encClicksToFeet = 2*PI*radius/3050;
...
void loop() {  
  ...
  float distanceRise = TARGET_DISTANCE/4000 * desired_Ts_ms;
  float angleRise = TARGET_ANGLE_DEG*PI/180/1500 * desired_Ts_ms;
